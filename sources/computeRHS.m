...
function [systemDeltauRHS, FextG, fs, Stress] = computeRHS( Conec, ...
  ...
  fs = assembler ( ...
    Conec, crossSecsParamsMat, coordsElemsMat, materialsParamsMat, KS, Utp1, 1, Udottp1, ...
    Udotdottp1, nodalDispDamping, solutionMethod, booleanConsistentMassMat, booleanCSTangs, elementsParamsMat ) ;
  ...
  elseif solutionMethod == 4
    ...
    fs = assembler ( ...
      ...
      Udotdott, nodalDispDamping, solutionMethod, booleanConsistentMassMat, booleanCSTangs, elementsParamsMat ) ;

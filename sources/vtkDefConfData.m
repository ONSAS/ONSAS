...
function [ Conecvtk, Nodesvtk, vtkDispMat, vtkNormalForceMat ] = vtkRefConfData ( Nodes, Conec, indexesElems, secc, UG, coordsElem, normalForce )
% ------------------------------------------------------------------------------
...
elseif secc(1) == 12     
  ...
  vtkDispMat = dispMat ;
  vtkNormalForceMat = vtkNormalForceMat ;
end

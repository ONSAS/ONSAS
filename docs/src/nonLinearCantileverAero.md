...
--------------------
 A large dipslacements dynamic 3D case is presented as follows. This example is inspierd on [Vortex-Induced Vibration of Soft Corals](https://www.youtube.com/watch?v=Lf9Ffj5rGh8&ab_channel=FrederickGosselin).
---------------------
### MEBI parameters
---------------------

### analysisSettings  
 Regarding the integration time method scheme, a classic $\alpha-HHT$ method is employed. This method is more numercially stable than Newmark, the keen reader is refereed to [this reference](https://onlinelibrary.wiley.com/doi/abs/10.1002/eqe.4290050306):
```
...
```
 The velocity function is assambled and plotted to ilustrate the reader
```
...
```
 ...
 ONSAS software is executed for the parameters above defined and the displacement solution of each load(time) step is saved into matUsLD3D matrix:
```

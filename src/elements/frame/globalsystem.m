...
function [ fs , ks, fintLocCoord, params_plastic_2Dframe_np1] = globalsystem(elemNodesxyzRefCoords , ...
    elemCrossSecParams    , ...
    modelParams , ...
    elemDisps, params_plastic_2Dframe, element)
...
[kp_np1, xi1_np1, Cep_np1, alfa_np1, xi2_np1, xdi_np1] = localsystem( E, Iy, xpi, xi1_n, kp_n, My, Mc, kh1, kh2, Mnp1, xd_n, alfa_n, xi2_n, tM_np1, l, Mu, Ks, SH_boole_np1) ;

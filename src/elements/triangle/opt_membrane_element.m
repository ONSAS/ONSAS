...
function [Km] = opt_membrane_element(E, nu, h, A, x02, x03, y03)
    ...
    %
    % OPT free parameters
    beta0 = max( 1/2 * (1 - 4 * nu^2), 0.01 );% beta0 = 3/2 for isotropic material - 5.7 (for stresses) 
    beta1 = 1;
    beta2 = 2;
    beta3 = 1;
    beta4 = 0;
    ...
    f = 3/4;
    Ktheta = f * beta0  * A * h * ( Q4' * Enat * Q4 + Q5' * Enat * Q5 + Q6' * Enat * Q6 ); % eq 31

...
function [Nodesvtk, Conecvtk, Dispsvtk] = vtkBeam2SolidConverter(coordsElemNodes, dispsElem, coordLocSubElem, dispLocIni, dispLocEnd, locRotIni, locRotEnd, sectPar, Rr, R0)

function fagElem = aeroForce(elemCoords, elemCrossSecParams, Ue, Udote, Udotdote, userDragCoef, userLiftCoef, userMomentCoef, elemTypeAero, userWindVel, numGaussPoints,geometricNonLinearAero)                               
  ...
  for ind = 1 : length( xIntPoints )
      ...
      fagElem =  fagElem + lo/2 * wIntPoints(ind) * integAeroForce(xGauss, ddotg, udotWindElem, lo, l, nu, nu11, nu12, nu21, nu22, tl1, tl2, Rr, Ro, vecChordUndef, dimCaracteristic, I3, O3, P, G, EE, L2, L3, boolRigidRotation, userDragCoef, userLiftCoef, userMomentCoef ) ;
  end
  % express aerodinamic force in ONSAS nomencalture  [force1 moment1 force2 moment2  ...];
  fagElem = Cambio_Base(fagElem);
end

function integAeroForce = integAeroForce(x, ddotg, udotWindElem, lo, l, nu, nu11, nu12, nu21, nu22, tl1, tl2, Rr, Ro, vecChordUndef, dimCaracteristic, I3, O3, P, G, EE, L2, L3, boolRigidRotation, userDragCoef, userLiftCoef, userMomentCoef )

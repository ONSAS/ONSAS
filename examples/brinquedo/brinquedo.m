...
[fsNL,~,~,KlNL] = internalForcesShellTriangle(reshape( mesh.nodesCoords', 1,9 ), elemDisps_rotx , 'elastic-linear', [ E nu], tz);

fsNL = fsNL{1};

[fsL,~,~,KeL] = internalForcesLinearShellTriangle(reshape( mesh.nodesCoords', 1,9 ), elemDisps_rotx , 'elastic-linear', [ E nu], tz);

...
analysisSettings.incremArcLen       = [1e-3*ones(1,5) 1e-4*ones(1,530) 1e-5*ones(1,17000) 1e-6*ones(1,10000)] ;
...
analysisSettings.methodName         = 'arcLength' ;
analysisSettings.deltaT             = 1 ;
analysisSettings.incremArcLen       = [1e-2*ones(1,1) 1e-3*ones(1,22) 1e-4*ones(1,1450) 1e-5*ones(1,17000) 1e-6*ones(1,5000)] ;
analysisSettings.finalTime          = length(analysisSettings.incremArcLen) ;
analysisSettings.iniDeltaLamb       = 1 ;
analysisSettings.posVariableLoadBC  = 2 ;
analysisSettings.stopTolDeltau      = 1e-8 ;
